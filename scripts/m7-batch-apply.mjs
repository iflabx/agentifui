...
async function snapshotTargetData(targetClient) {
  ...
  try {
    await targetClient.query(
      `CREATE SCHEMA IF NOT EXISTS ${quoteIdent(dataSnapshotSchema)}`
    );
    ...
    const steps = [
      ...
      },
      {
        ...
        env: {
          ...
          M7_DUAL_READ_REQUIRE_FULL_COVERAGE: batchDualReadRequireFullCoverage
            ? '1'
            : '0',
        },
      },
      {
        ...
        env: {
          ...
          M7_STORAGE_REQUIRE_FULL_COVERAGE: batchStorageRequireFullCoverage
            ? '1'
            : '0',
        },
      },
